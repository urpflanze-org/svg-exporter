...
/* harmony export */ });
/* harmony import */ var _urpflanze_color__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
class SVGExporter {
    ...
    static bindColorAttribute(type, color, attriburesPtr, stylePtr) {
        ...
        if (color === 'none') {
            ...
            const parsed = (0,_urpflanze_color__WEBPACK_IMPORTED_MODULE_0__.parseColorAndConvert)(color);
            if (parsed) {
                if (parsed.alpha !== 1) {
                    stylePtr.push(`${type}-opacity: ${parsed.alpha}`);
                }
                attriburesPtr.push(`${type}="${(0,_urpflanze_color__WEBPACK_IMPORTED_MODULE_0__.rgbToHex)(parsed.r, parsed.g, parsed.b)}"`);
            }
        }
    }
    /**
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SVGExporter": () => (/* reexport safe */ _SVGExporter__WEBPACK_IMPORTED_MODULE_1__.SVGExporter)
/* harmony export */ });
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _SVGExporter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);


//# sourceMappingURL=index.js.map
})();

var __webpack_exports__SVGExporter = __webpack_exports__.SVGExporter;
export { __webpack_exports__SVGExporter as SVGExporter };
